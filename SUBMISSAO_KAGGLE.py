...
# # Introduction
# 
# ## pense no problema, que problemas vamos resolver aqui? Preços
# Machine learning competitions are a great way to improve your data science skills and measure your progress. 
# 
# In this exercise, you will create and submit predictions for a Kaggle competition. You can then improve your model (e.g. by adding features) to improve and see how you stack up to others taking this micro-course.
# 
# Criar e submeter predições
# em uma competição Kaggle
# melhorar o modelo
# adicionar features
# verificar se melhorou
# 
# Vamos criar e submetdir
...
# Imports necessários, antes de ler pense em quais vc acha que são as bibliotecas 
#  e a quais grupos elas pertencem
import pandas as pd
...
# 
# ## o problema é o preço das casas de iowa, temos um monte de features, vamos ver
...
# output.to_csv('submission.csv', index=False)Read the file of "test" data. And apply your model to make predictions
...
test_data_path = 'dados/Iowa House Prices/test.csv'
